...
- Windows 10/11
- Npcap
- Активный игровой клиент Warspear Online 13.1.1
...
2.  Запустите `ws-logger.exe` с правами администратора.
3.  Используйте кнопки **"Начать"** и **"Стоп"** для управления сбором статистики.
